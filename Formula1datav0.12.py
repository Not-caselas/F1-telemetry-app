...
def comparison():
    try:
        ...
        # Speed trace
        ax[1].plot(telemetry_driver_1[Value], telemetry_driver_1['Speed'], label=Driver1+" "+str(fastest_driver_1["LapTime"]).replace("0 days 00:0", "").replace("000", ""), color=ff1.plotting.driver_color(Driver1))
        ax[1].plot(telemetry_driver_2[Value], telemetry_driver_2['Speed'], label=Driver2+" "+str(fastest_driver_2["LapTime"]).replace("0 days 00:0", "").replace("000", ""), color=ff1.plotting.driver_color(Driver2))
        ...
        # Throttle trace
        ax[2].plot(telemetry_driver_1[Value], telemetry_driver_1['Throttle'], label=Driver1, color=ff1.plotting.driver_color(Driver1))
        ax[2].plot(telemetry_driver_2[Value], telemetry_driver_2['Throttle'], label=Driver2, color=ff1.plotting.driver_color(Driver2))
        ...
        # Brake trace
        ax[3].plot(telemetry_driver_1[Value], telemetry_driver_1['Brake'], label=Driver1, color=ff1.plotting.driver_color(Driver1))
        ax[3].plot(telemetry_driver_2[Value], telemetry_driver_2['Brake'], label=Driver2, color=ff1.plotting.driver_color(Driver2))
        ...
        # Gear trace
        ax[4].plot(telemetry_driver_1[Value], telemetry_driver_1['nGear'], label=Driver1, color=ff1.plotting.driver_color(Driver1))
        ax[4].plot(telemetry_driver_2[Value], telemetry_driver_2['nGear'], label=Driver2, color=ff1.plotting.driver_color(Driver2))
        ...
        # RPM trace
        ax[5].plot(telemetry_driver_1[Value], telemetry_driver_1['RPM'], label=Driver1, color=ff1.plotting.driver_color(Driver1))
        ax[5].plot(telemetry_driver_2[Value], telemetry_driver_2['RPM'], label=Driver2, color=ff1.plotting.driver_color(Driver2))
        ...
        # DRS trace
        ax[6].plot(telemetry_driver_1[Value], telemetry_driver_1['DRS'], label=Driver1, color=ff1.plotting.driver_color(Driver1))
        ax[6].plot(telemetry_driver_2[Value], telemetry_driver_2['DRS'], label=Driver2, color=ff1.plotting.driver_color(Driver2))
